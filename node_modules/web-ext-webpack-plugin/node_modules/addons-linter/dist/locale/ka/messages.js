module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "String name is reserved for a predefined message":[ "სტრიქონის დასახელება განკუთვნილია წინასწარ განსაზღვრული შეტყობინების სათადარიგოდ" ],
      ...
      "messages.json file missing in \"%(path)s\"":[ "messages.json ფაილის ვერ მოიძებნა \"%(path)s\" მისამართზე" ],
