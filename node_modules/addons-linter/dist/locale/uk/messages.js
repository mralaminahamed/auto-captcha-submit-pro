module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` викликається справжнім четвертим аргументом." ],
      ...
      "Firefox add-ons are not allowed to run coin miners.":[ "Додаткам Firefox не дозволено виконувати майнинг." ],
      ...
      "A custom content_security_policy needs additional review.":[ "custom content_security_policy потребує додаткової перевірки." ],
      ...
      "The \"version\" property must be a string.":[ "Властивість \"version\" повинна бути рядком." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Перегляньте http://mzl.la/1kXIADa (Документацію MDN) для отримання докладної інформації." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Властивість \"version\" використовує специфічний для Firefox формат." ] } } }