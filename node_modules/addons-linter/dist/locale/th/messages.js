module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener ถูกเรียกโดยอาร์กิวเมนต์ที่ 4 ที่เป็นค่าจริง" ],
      ...
      "Your JSON contains block comments.":[ "JSON ของคุณมีหมายเหตุการบล็อก" ],
      ...
      "A custom content_security_policy needs additional review.":[ "content_security_policy ที่กำหนดเองจำเป็นต้องมีการตรวจทานเพิ่มเติม" ],
      "The \"name\" property must be a string.":[ "คุณสมบัติ \"name\" ต้องเป็นสตริง" ],
      ...
      "The \"version\" property must be a string.":[ "คุณสมบัติ \"version\" ต้องเป็นสตริง" ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "ดู http://mzl.la/1kXIADa (คู่มือ MDN) สำหรับข้อมูลเพิ่มเติม" ],
      "The \"version\" property uses a Firefox-specific format.":[ "คุณสมบัติ \"version\" ใช้รูปแบบเฉพาะของ Firefox" ] } } }