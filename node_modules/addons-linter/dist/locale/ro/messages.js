module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Known JS library detected":[ "S-a depistat o librărie JS cunoscută" ],
      ...
      "Banned 3rd-party JS library":[ "Librărie JS de la terți interzisă" ],
      "Unadvised 3rd-party JS library":[ "Librărie JS de la terți nerecomandată" ],
      ...
      "A custom content_security_policy needs additional review.":[ "O content_security_policy personalizată necesită o recenzie suplimentară." ],
      "The \"name\" property must be a string.":[ "Proprietatea „name” trebuie să fie un șir." ],
      ...
      "The \"version\" property must be a string.":[ "Proprietatea „versiune” trebuie să fie un șir." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Vezi http://mzl.la/1kXIADa (Documentația MDN) pentru mai multe informații." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Proprietatea „version” folosește un format specific Firefox." ] } } }